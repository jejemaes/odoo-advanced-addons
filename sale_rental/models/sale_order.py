...
class SaleOrder(models.Model):
    ...
    def action_view_rental(self):
        ...
        return {
            ...
            'views': [(False, 'calendar'), (False, 'gantt'), (False, 'kanban'), (False, 'tree'), (False, 'form')],
...
class SaleOrderLine(models.Model):
    ...
    @api.model
    def _default_procut_uom_qty(self):
        if self._context.get('default_is_rental'):
            return None
        return 1.0

    # Other when not given in create values, the value of `product_uom_qty` will be 1.0 (as defined
    # in sale addon), but the computation in `_compute_uom_qty` will not be called.
    ...
    def _compute_qty_delivered(self):
        ...
        super(SaleOrderLine, self - lines_by_rental)._compute_qty_delivered()
